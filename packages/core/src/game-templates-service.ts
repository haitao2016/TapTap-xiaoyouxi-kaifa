...
export class GameTemplatesService {
  ...
  getTemplateTypes(): { id: GameTemplateType; name: string; icon: string; description: string; count: number }[] {
  ...
  private createMatch3Template(now: number, day: number): GameTemplate {
    return {
        ...
        children: [
          {
            ...
            path: '/src',
            children: [
              { name: 'game', type: 'directory', path: '/src/game', children: [
                { name: 'Board.ts', type: 'file', path: '/src/game/Board.ts', size: 20480, extension: 'ts' },
                { name: 'MatchLogic.ts', type: 'file', path: '/src/game/MatchLogic.ts', size: 25600, extension: 'ts' },
                { name: 'Piece.ts', type: 'file', path: '/src/game/Piece.ts', size: 10240, extension: 'ts' },
                { name: 'PowerUp.ts', type: 'file', path: '/src/game/PowerUp.ts', size: 15360, extension: 'ts' },
              ]},
              { name: 'levels', type: 'directory', path: '/src/levels', children: [
                { name: 'LevelManager.ts', type: 'file', path: '/src/levels/LevelManager.ts', size: 12288, extension: 'ts' },
                { name: 'levelData.json', type: 'file', path: '/src/levels/levelData.json', size: 51200, extension: 'json' },
              ]},
              { name: 'ui', type: 'directory', path: '/src/ui', children: [
                { name: 'GameUI.ts', type: 'file', path: '/src/ui/GameUI.ts', size: 18432, extension: 'ts' },
                { name: 'LevelSelect.ts', type: 'file', path: '/src/ui/LevelSelect.ts', size: 15360, extension: 'ts' },
                { name: 'MainMenu.ts', type: 'file', path: '/src/ui/MainMenu.ts', size: 12288, extension: 'ts' },
              ]},
          ...
          { name: 'project.json', type: 'file', path: '/project.json', size: 2048, extension: 'json' },
      ...
      fileCount: 48,
      configParams: [
        { id: 'boardSize', name: '棋盘大小', description: '游戏棋盘的尺寸', type: 'select', defaultValue: 8, category: '游戏玩法', options: [
          { value: 6, label: '6x6 (简单)' },
          { value: 7, label: '7x7 (中等)' },
          { value: 8, label: '8x8 (标准)' },
          { value: 9, label: '9x9 (困难)' },
        ]},
        { id: 'matchMin', name: '最小匹配数', description: '触发消除的最少方块数', type: 'number', defaultValue: 3, min: 3, max: 5, category: '游戏玩法' },
        { id: 'comboTime', name: '连击时间窗口', description: '连续消除的时间窗口（秒）', type: 'number', defaultValue: 2, min: 1, max: 5, category: '游戏玩法' },
        { id: 'startMoves', name: '初始步数', description: '每关的初始步数', type: 'number', defaultValue: 20, min: 10, max: 50, category: '关卡设置' },
        { id: 'scoreMultiplier', name: '分数倍率', description: '整体得分倍率', type: 'number', defaultValue: 1, min: 0.5, max: 3, category: '分数系统' },
        { id: 'enableSound', name: '启用音效', description: '是否播放游戏音效', type: 'boolean', defaultValue: true, category: '音频设置' },
        { id: 'enableMusic', name: '启用音乐', description: '是否播放背景音乐', type: 'boolean', defaultValue: true, category: '音频设置' },
        { id: 'themeColor', name: '主题色', description: '游戏界面主题色', type: 'color', defaultValue: '#FF6B9D', category: '视觉设置' },
      ],
      defaultDifficulty: 'normal',
      availableDifficulties: ['easy', 'normal', 'hard'],
      skins: [
        { id: 'default', name: '经典糖果', description: '经典的糖果风格主题', previewImage: 'skin-candy.png', themeColor: '#FF6B9D' },
        { id: 'fruits', name: '水果乐园', description: '新鲜水果风格主题', previewImage: 'skin-fruits.png', themeColor: '#4CAF50' },
        { id: 'gems', name: '宝石迷阵', description: '闪亮宝石风格主题', previewImage: 'skin-gems.png', themeColor: '#9C27B0' },
        { id: 'ocean', name: '海洋之心', description: '海洋主题风格', previewImage: 'skin-ocean.png', themeColor: '#2196F3' },
      ],
  ...
  private createPlatformerTemplate(now: number, day: number): GameTemplate {
    return {
      ...
      description: '完整的2D平台跳跃游戏模板，包含角色控制、关卡设计、金币收集、敌人系统等完整功能。',
      longDescription: '这是一个经典的2D平台跳跃游戏项目模板，提供了完整的游戏框架。\n\n**角色控制**：流畅的移动、精确的跳跃、墙壁滑行、二段跳等多种动作。\n\n**关卡系统**：内置10个精心设计的关卡，支持关卡编辑器。\n\n**收集系统**：金币、宝石、道具等多种收集要素。\n\n**敌人系统**：多种敌人类型，各有特色的AI行为。',
      version: '1.5.0',
      ...
      fileCount: 56,
      configParams: [
        { id: 'playerSpeed', name: '移动速度', description: '玩家移动速度', type: 'number', defaultValue: 5, min: 1, max: 10, category: '角色控制' },
        { id: 'jumpForce', name: '跳跃力', description: '跳跃初始力度', type: 'number', defaultValue: 12, min: 5, max: 20, category: '角色控制' },
        { id: 'gravity', name: '重力', description: '重力加速度', type: 'number', defaultValue: 0.5, min: 0.1, max: 1, category: '物理设置' },
        { id: 'doubleJump', name: '二段跳', description: '是否允许二段跳', type: 'boolean', defaultValue: true, category: '角色控制' },
        { id: 'wallSlide', name: '墙壁滑行', description: '是否允许墙壁滑行', type: 'boolean', defaultValue: true, category: '角色控制' },
      ],
      defaultDifficulty: 'normal',
      availableDifficulties: ['easy', 'normal', 'hard', 'extreme'],
      skins: [
        { id: 'default', name: '像素风格', description: '经典像素艺术风格', previewImage: 'skin-pixel.png', themeColor: '#FF9800' },
        { id: 'cartoon', name: '卡通风格', description: '可爱卡通风格', previewImage: 'skin-cartoon.png', themeColor: '#E91E63' },
        { id: 'neon', name: '霓虹风格', description: '赛博朋克霓虹风', previewImage: 'skin-neon.png', themeColor: '#00BCD4' },
      ],
      defaultSkinId: 'default',
      levelCount: 10,
      levels: Array.from({ length: 10 }, (_, i) => ({
        id: `level-${i + 1}`,
        name: `关卡 ${i + 1}`,
        description: ['草原启程', '森林探秘', '洞穴冒险', '机关重重', 'BOSS挑战', '雪山之巅', '天空之城', '机械工厂', '熔岩地狱', '最终决战'][i],
  ...
  private createRoguelikeTemplate(now: number, day: number): GameTemplate {
    return {
      ...
      description: '完整的Roguelike动作游戏模板，包含随机地牢生成、角色成长、装备系统、技能树等核心功能。',
      longDescription: '这是一个功能丰富的Roguelike游戏项目模板，为你的地牢探险游戏提供坚实基础。\n\n**随机地牢**：每次游戏都会生成完全不同的地牢布局。\n\n**角色成长**：多种职业、技能树、属性成长系统。\n\n**装备系统**：武器、防具、饰品，丰富的装备组合。\n\n**多样化敌人**：普通怪物、精英怪、BOSS，层层递进的挑战。',
      version: '1.2.0',
      minTapDevVersion: '0.4.0',
      author: 'TapDev官方',
      authorId: 'tapdev-official',
      ...
      fileCount: 78,
      configParams: [
        { id: 'dungeonSize', name: '地牢大小', description: '地牢生成的尺寸范围', type: 'select', defaultValue: 'medium', category: '地牢生成', options: [
          { value: 'small', label: '小型（快节奏）' },
          { value: 'medium', label: '中型（标准）' },
          { value: 'large', label: '大型（探索向）' },
        ]},
        { id: 'roomDensity', name: '房间密度', description: '地牢中的房间数量', type: 'number', defaultValue: 0.6, min: 0.3, max: 0.9, category: '地牢生成' },
        { id: 'enemyDifficulty', name: '敌人强度', description: '敌人属性倍率', type: 'number', defaultValue: 1, min: 0.5, max: 3, category: '难度设置' },
        { id: 'permadeath', name: '永久死亡', description: '是否启用永久死亡', type: 'boolean', defaultValue: true, category: '游戏规则' },
      ],
      defaultDifficulty: 'normal',
      availableDifficulties: ['easy', 'normal', 'hard', 'extreme'],
      skins: [
        { id: 'default', name: '暗黑地牢', description: '经典暗黑地牢风格', previewImage: 'skin-dark.png', themeColor: '#5D4037' },
        { id: 'pixel', name: '像素地牢', description: '复古像素风格', previewImage: 'skin-pixel-dungeon.png', themeColor: '#33691E' },
        { id: 'scifi', name: '太空站', description: '科幻太空站风格', previewImage: 'skin-scifi.png', themeColor: '#0D47A1' },
      ],
      defaultSkinId: 'default',
      levelCount: 10,
      levels: Array.from({ length: 10 }, (_, i) => ({
  ...
  private createCardTemplate(now: number, day: number): GameTemplate {
    return {
      ...
      longDescription: '这是一套完整的卡牌游戏开发模板，让你快速搭建自己的TCG卡牌游戏。\n\n**战斗系统**：回合制战斗，丰富的卡牌效果，AI对手。\n\n**卡组构建**：收藏卡牌，构建个性化卡组。\n\n**单人战役**：多个章节，层层递进的挑战。\n\n**卡牌收集**：抽卡系统，卡牌合成，图鉴收集。',
      version: '1.1.0',
      minTapDevVersion: '0.4.0',
      author: 'TapDev官方',
      authorId: 'tapdev-official',
      ...
      fileCount: 65,
      configParams: [
        { id: 'startHealth', name: '初始生命', description: '双方初始生命值', type: 'number', defaultValue: 30, min: 10, max: 100, category: '战斗设置' },
        { id: 'startHand', name: '起始手牌', description: '游戏开始时的手牌数', type: 'number', defaultValue: 4, min: 1, max: 10, category: '战斗设置' },
        { id: 'maxMana', name: '最大法力', description: '每回合最大法力值', type: 'number', defaultValue: 10, min: 5, max: 20, category: '战斗设置' },
        { id: 'deckSize', name: '卡组大小', description: '规定的卡组卡牌数', type: 'number', defaultValue: 30, min: 20, max: 60, category: '卡组设置' },
      ],
      defaultDifficulty: 'normal',
      availableDifficulties: ['easy', 'normal', 'hard'],
      skins: [
        { id: 'default', name: '经典奇幻', description: '经典奇幻风格卡牌', previewImage: 'skin-fantasy.png', themeColor: '#8B4513' },
        { id: 'scifi', name: '星际科幻', description: '未来科幻风格卡牌', previewImage: 'skin-sci-fi.png', themeColor: '#1E88E5' },
        { id: 'cute', name: '可爱萌系', description: 'Q版可爱风格卡牌', previewImage: 'skin-cute.png', themeColor: '#EC407A' },
      ],
      defaultSkinId: 'default',
      levelCount: 20,
  ...
  private createTowerDefenseTemplate(now: number, day: number): GameTemplate {
    return {
      ...
      longDescription: '这是一个经典的塔防游戏项目模板，提供了完整的塔防游戏框架。\n\n**防御塔**：多种防御塔类型，各有特点和升级路线。\n\n**敌人波次**：多种敌人类型，一波接一波的挑战。\n\n**地图系统**：多张地图，不同的路径布局。\n\n**升级系统**：塔升级、技能树、全局强化。',
      version: '1.3.0',
      minTapDevVersion: '0.3.0',
      author: 'TapDev官方',
      authorId: 'tapdev-official',
      ...
      fileCount: 52,
      configParams: [
        { id: 'startGold', name: '初始金币', description: '游戏开始时的金币数', type: 'number', defaultValue: 500, min: 100, max: 2000, category: '经济系统' },
        { id: 'startLives', name: '初始生命', description: '可以漏掉的敌人数量', type: 'number', defaultValue: 20, min: 1, max: 100, category: '游戏设置' },
        { id: 'sellRefund', name: '出售返还', description: '出售塔返还金币比例', type: 'number', defaultValue: 0.7, min: 0, max: 1, category: '经济系统' },
        { id: 'waveInterval', name: '波次间隔', description: '波次之间的间隔（秒）', type: 'number', defaultValue: 5, min: 1, max: 20, category: '游戏设置' },
      ],
      defaultDifficulty: 'normal',
      availableDifficulties: ['easy', 'normal', 'hard', 'extreme'],
      skins: [
        { id: 'default', name: '中世纪', description: '经典中世纪风格', previewImage: 'skin-medieval.png', themeColor: '#8D6E63' },
        { id: 'scifi', name: '科幻塔防', description: '未来科技风格', previewImage: 'skin-futuristic.png', themeColor: '#00BCD4' },
        { id: 'nature', name: '自然之塔', description: '自然森林风格', previewImage: 'skin-nature.png', themeColor: '#4CAF50' },
      ],
      defaultSkinId: 'default',
      levelCount: 15,
